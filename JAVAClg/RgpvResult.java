...
public class RgpvResult {
    ...
    public static void main(String[] args) {
        ...
        if (enrl.equals("0834CS211007")&& s==6) {
            ...
            System.out.println("NOTE:- USE TAB BUTTON FOR ENTERING MARKS");
            ...
            String result = hasFailed ? "Fail in " + failedSubjects.toString() : "Pass";
             ...
             if (m1>=81) {
                System.out.println("601(T)                     "+m1+"                     A");
                }
            else if (m1>=61) {
                System.out.println("601(T)                     "+m1+"                     B");
                }
            else if (m1>=41) {
                System.out.println("601(T)                     "+m1+"                     C");
                }
            else {
                System.out.println("601(T)                     "+m1+"                     F");
                }
           
            if (m2>=81) {
                System.out.println("602(T)                     "+m2+"                     A");
                    }
            else if (m2>=61) {
                System.out.println("602(T)                     "+m2+"                     B");
                    }
            else if (m2>=41) {
                System.out.println("602(T)                     "+m2+"                     C");
                    }
            else {
                System.out.println("602(T)                     "+m2+"                     F");
                    }
                         
             if (m3>=81) {
                System.out.println("603(T)                     "+m3+"                     A");
                }
            else if (m3>=61) {
                System.out.println("603(T)                     "+m3+"                     B");
                }
            else if (m3>=41) {
                System.out.println("603(T)                     "+m3+"                     C");
                }
            else {
                System.out.println("603(T)                     "+m3+"                     F");
                }
        
             if (m4>=81) {
                System.out.println("604(T)                     "+m4+"                     A");
                }
            else if (m4>=61) {
                System.out.println("604(T)                     "+m4+"                     B");
                }
            else if (m4>=41) {
                System.out.println("604(T)                     "+m4+"                     C");
                }
            else {
                System.out.println("604(T)                     "+m4+"                     F");
                }
            System.out.println("");
           ...
           else{System.out.println("Invaild Enrollment Number OR Semester!!please Re-Enter");}
